...
device = 'cuda'
batch_size = 4096
best_params = {'embedding_dim': 733, 'margin': 4.34803316025036, 'num_negs_per_pos': 8}
...
loss_function = MarginRankingLoss(margin=best_params['margin'])
model = RotatE(
...
training_loop = SLCWATrainingLoop(
    ...
    negative_sampler_kwargs=dict(
        num_negs_per_pos=best_params['num_negs_per_pos']
    )
)
...
metrics.to_csv("/mnt/tank/scratch/pbogdanov/link_pykeen/results/rotate_iw_hs_best_metrics.csv")